...
`Keywords`: document understanding, Q&A chatbot, multi-category processing, research papers, articles, books, receipts, terms and conditions

`Tech Stack`: 
- Python
- LangChain
- Faiss/Chroma/Milvus/Typesense (vector store)
- PDF/Text/Docx parsers
...
### Document Categories:
- **Research Paper**: Academic papers, journals, conference proceedings
- **Article**: News articles, blog posts, magazine content
- **Book**: Textbooks, novels, reference materials
- **Other**: General documents not fitting specific categories
- **Receipts**: Purchase receipts, invoices, financial documents
- **Terms & Conditions**: Legal documents, contracts, policy documents
...
- **Document classification**: Identify document category upon upload (Research Paper, Article, Book, Other, Receipts, Terms & Conditions)
- **Category-specific parsing**: Extract text using appropriate methods for each document type
